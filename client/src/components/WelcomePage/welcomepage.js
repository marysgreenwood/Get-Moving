      ...
      <Container className="homepage-container">
        ...
        <Row className="sub-section">
          ...
          <Col xs={6} md={8} className="text-box">
            ...
            <p>
              Moving is never easy, no matter how many times you've moved. With{" "}
              <strong>GET MOVING</strong> we are here to help keep your mind at
              ease. You create the list, we check the boxes.
            </p>
          </Col>
        </Row>
      </Container>
